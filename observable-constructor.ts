...
export interface ObservableConstructor {
  /**
   * Creates and returns an object that acts as a template for connecting a [`producer`](https://jsr.io/@xan/observer#producer)
   * to a [`consumer`](https://jsr.io/@xan/observer#consumer) via a {@linkcode Observable.subscribe|subscribe} action.
